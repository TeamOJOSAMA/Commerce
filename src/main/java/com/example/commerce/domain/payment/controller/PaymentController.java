...
public class PaymentController {
    ...
    public ApiResponse<PaymentResponse> approvePayment(
        ...
        return ApiResponse.ok("결제가 승인되었습니다.", paymentService.approvePayment(authUser.getUserId(), paymentId));
    }
    ...
    public ApiResponse<PaymentResponse> failPayment(
        ...
        return ApiResponse.ok("결제가 실패 처리되었습니다.",
    ...
    public ApiResponse<PaymentResponse> getPayment(
        ...
        return ApiResponse.ok(paymentService.getPaymentDetail(authUser.getUserId(), paymentId));
    }
}
